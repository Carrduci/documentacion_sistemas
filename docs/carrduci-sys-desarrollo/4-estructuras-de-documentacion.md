...
Ver [agregar snippets a visual studio code](./docs/visual-studio-code/1-agregar-snippets.md).
...
5. Usar el separador de sección mostrado en el apartado **Estructuras Generales (snippets)** y poner el código entre las estructuras resultantes cuando se indique que se debe seguir un orden de secciones. A manera de sub-secciones, se puede usar el sub separador de sección dentro de los separadores de sección.
...
```
	"Sub separador de seccion": {
		...
		"body": [
			...
			"",
			"// (o,,,,,,,,,,,${1/(.)/,/g},,,,^,,,,,o)",
			"//   #endregion ${1/(.*)/${1:/downcase}/}",
			"// (o'''''''''''${1/(.)/'/g}''''''''''o)"
		],
		"description": "Pequeños marcadores de sección."
	},
```
